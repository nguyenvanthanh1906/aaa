...
export default class Login extends Component {
            ...
            .then(res => {
                if (res.status == 200) {
                    ...
                    if (localStorage.role == "customer") {
                        instance.get("api/v1/customers/" + localStorage.user, {
                        ...
                        instance.get("api/v1/companies/" + localStorage.user, {
    ...
    render() {
        return (
            <div style={{ backgroundImage: "url('https://cdn.wallpapersafari.com/62/32/6Eborf.jpg')", height: '1080px', backgroundSize: 'cover', backgroundPosition: 'center' }}>
